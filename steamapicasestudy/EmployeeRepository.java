...
public class EmployeeRepository {
	public static void main(String[] args) {
		...
		empList = Arrays.asList(
				new Employee(100, 1, "Shivani", "Mandlik", "patilshivani2000@gmail.com", "9158188800", "Executive",
						LocalDate.of(2022, 2, 21), 25000d, dept),
				new Employee(201, 2, "Nikita", "Kangude", "nikitakangude@gmail.com", "9096689999", "Analyst",
